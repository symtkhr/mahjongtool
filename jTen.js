...
var PointQuiz = function(){
  ...
  this.level_det = function(){
    ...
    var is_pingf = (QStat.yaku.index("平和(1)") >= 0 );
    ...
    */
	...
	if( Math.ceil(QStat.fu/10) == 7 )                    { lv += 10; debug += "+70符"; } 
	if( Math.ceil(QStat.fu/10) == 9 && QStat.ch_kz == 0 ){ lv += 10; debug += "+90符親"; } 
      }
...
function show_tingpai(){
  ...
  if(is_reach) output_string += '<img src="./haiga/reach.png" alt="立直棒">';
  output_string += "<br>";
  var t = gResObj.HandObj.t;
